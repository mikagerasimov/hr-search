...
def to_csv(excel_file):
    # Переводит нужный лист и строки в цсв. Можно было ли обойтись? Не еду, гпт сказало через цсв срать.
...
#     print("Данные успешно загружены!")
    ...
    #Мне похуй, пусть через пандас Миша все пишет, даже я ебал sql еще учить и тупо через гпт делал
def from_bd():
